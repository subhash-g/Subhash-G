...
module.exports = {
	...
	identifyUser: function(apiKey, properties, callback) {
		var options = this.defaultOptions(apiKey);
		var payload = { 'subscriber': properties };
		options.path = '/201507/subscribers/identify';
		options.method = 'POST';
		client.executeRequest(options, payload, callback);
	},
